...
export const vintageTheme = createTheme({
  ...
  typography: {
    ...
    subtitle1: { fontFamily: "Georgia, 'Times New Roman', serif", fontWeight: 600 },
    body1: { fontFamily: "Georgia, 'Times New Roman', serif" },
    body2: { fontFamily: "Georgia, 'Times New Roman', serif" },
    button: { fontFamily: "Georgia, 'Times New Roman', serif", fontWeight: 500 },
  },
  ...
  components: {
    MuiPaper: {
      styleOverrides: {
        ...
        elevation2: { border: '2px solid #d4a574' },
        elevation3: { border: '2px solid #d4a574' },
        elevation4: { border: '2px solid #d4a574' },
      },
    },
    MuiButton: {
      styleOverrides: {
        ...
        contained: {
          ...
          '&:hover': { boxShadow: '0 4px 8px rgba(92, 74, 47, 0.3)' },
        },
        outlined: {
          borderWidth: '2px',
    ...
    MuiAvatar: {
      styleOverrides: {
        root: { border: '3px solid #faf7f0', boxShadow: '0 2px 4px rgba(92, 74, 47, 0.2)' },
      },
    },
  },
});
